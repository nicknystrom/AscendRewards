...
namespace Ascend.Web.Areas.Admin.Controllers {
    ...
    public partial class CatalogController {
        ...
        public class ViewNames {
            public readonly string CatalogCreateModel = "~/Areas/Admin/Views/Catalog/CatalogCreateModel.spark";
            public readonly string Edit = "~/Areas/Admin/Views/Catalog/Edit.spark";
            public readonly string Index = "~/Areas/Admin/Views/Catalog/Index.spark";
        }
    }

    [CompilerGenerated]
    class T4MVC_CatalogController: Ascend.Web.Areas.Admin.Controllers.CatalogController {
        ...
        public override System.Web.Mvc.ActionResult Index(Ascend.Web.Areas.Admin.Controllers.CatalogCreateModel c) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Index);
        ...
        public override System.Web.Mvc.ActionResult Edit(string id, Ascend.Web.Areas.Admin.Controllers.CatalogEditModel c) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Edit);
            callInfo.RouteValues.Add("id", id);
            callInfo.RouteValues.Add("c", c);
            return callInfo;
