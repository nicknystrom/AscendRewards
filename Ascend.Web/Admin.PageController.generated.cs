...
namespace Ascend.Web.Areas.Admin.Controllers {
    ...
    public partial class PageController {
        ...
        public class ViewNames {
            public readonly string Edit = "~/Areas/Admin/Views/Page/Edit.spark";
            public readonly string Index = "~/Areas/Admin/Views/Page/Index.spark";
            public readonly string PageCreateModel = "~/Areas/Admin/Views/Page/PageCreateModel.spark";
        }
    }

    [CompilerGenerated]
    class T4MVC_PageController: Ascend.Web.Areas.Admin.Controllers.PageController {
        ...
        public override System.Web.Mvc.ActionResult Index(Ascend.Web.Areas.Admin.Controllers.PageCreateModel p) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Index);
        ...
        public override System.Web.Mvc.ActionResult Edit(string id, Ascend.Web.Areas.Admin.Controllers.PageEditModel p) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Edit);
            callInfo.RouteValues.Add("id", id);
            callInfo.RouteValues.Add("p", p);
            return callInfo;
