...
namespace Ascend.Web.Areas.Admin.Controllers {
    ...
    public partial class GroupController {
        ...
        public class ViewNames {
            public readonly string Edit = "~/Areas/Admin/Views/Group/Edit.spark";
            public readonly string GroupCreateModel = "~/Areas/Admin/Views/Group/GroupCreateModel.spark";
            public readonly string Index = "~/Areas/Admin/Views/Group/Index.spark";
        }
    }

    [CompilerGenerated]
    class T4MVC_GroupController: Ascend.Web.Areas.Admin.Controllers.GroupController {
        ...
        public override System.Web.Mvc.ActionResult Index(Ascend.Web.Areas.Admin.Controllers.GroupCreateModel g) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Index);
            callInfo.RouteValues.Add("g", g);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(string id, Ascend.Web.Areas.Admin.Controllers.GroupEditModel g) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Edit);
            callInfo.RouteValues.Add("id", id);
            callInfo.RouteValues.Add("g", g);
            return callInfo;
