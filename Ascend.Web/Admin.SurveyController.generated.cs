...
namespace Ascend.Web.Areas.Admin.Controllers {
    ...
    public partial class SurveyController {
        ...
        public class ViewNames {
            public readonly string Edit = "~/Areas/Admin/Views/Survey/Edit.spark";
            public readonly string Index = "~/Areas/Admin/Views/Survey/Index.spark";
            public readonly string SurveyCreateModel = "~/Areas/Admin/Views/Survey/SurveyCreateModel.spark";
        }
    }

    [CompilerGenerated]
    class T4MVC_SurveyController: Ascend.Web.Areas.Admin.Controllers.SurveyController {
        ...
        public override System.Web.Mvc.ActionResult Index(Ascend.Web.Areas.Admin.Controllers.SurveyCreateModel s) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Index);
        ...
        public override System.Web.Mvc.ActionResult Edit(string id, Ascend.Web.Areas.Admin.Controllers.SurveyEditModel s) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Edit);
            callInfo.RouteValues.Add("id", id);
            callInfo.RouteValues.Add("s", s);
            return callInfo;
