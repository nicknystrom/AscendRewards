...
namespace Ascend.Web.Areas.Site.Controllers {
    ...
    public partial class SurveyController {
        ...
        public class ViewNames {
            public readonly string Index = "~/Areas/Site/Views/Survey/Index.spark";
            public readonly string Review = "~/Areas/Site/Views/Survey/Review.spark";
        }
    }

    [CompilerGenerated]
    class T4MVC_SurveyController: Ascend.Web.Areas.Site.Controllers.SurveyController {
        ...
        public override System.Web.Mvc.ActionResult Index(string id, Ascend.Web.Areas.Site.Controllers.SurveyResultViewModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Index);
            callInfo.RouteValues.Add("id", id);
