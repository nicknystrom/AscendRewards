...
namespace Ascend.Web.Areas.Admin.Controllers {
    ...
    public partial class GameController {
        ...
        public class ViewNames {
            public readonly string Edit = "~/Areas/Admin/Views/Game/Edit.spark";
            public readonly string GameCreateModel = "~/Areas/Admin/Views/Game/GameCreateModel.spark";
            public readonly string Index = "~/Areas/Admin/Views/Game/Index.spark";
        }
    }

    [CompilerGenerated]
    class T4MVC_GameController: Ascend.Web.Areas.Admin.Controllers.GameController {
        ...
        public override System.Web.Mvc.ActionResult Index(Ascend.Web.Areas.Admin.Controllers.GameCreateModel g) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Index);
        ...
        public override System.Web.Mvc.ActionResult Edit(string id, Ascend.Web.Areas.Admin.Controllers.GameEditModel g) {
            var callInfo = new T4MVC_ActionResult(Area, Name, Actions.Edit);
            callInfo.RouteValues.Add("id", id);
            callInfo.RouteValues.Add("g", g);
            return callInfo;
